  ...
  return (
    <article className="prose prose-neutral max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
      ...
      <div className="space-y-6 text-foreground/80 leading-relaxed">
        <p>
          Направляя форму записи на сайте {siteConfig.fullName} (далее — «Студия»),
          пользователь (родитель / законный представитель ребёнка) даёт согласие на обработку
          своих персональных данных и персональных данных ребёнка на следующих условиях,
          соответствующих требованиям Федерального закона от 27.07.2006 № 152-ФЗ
