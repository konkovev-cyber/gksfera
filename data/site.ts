...
export const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Стоимость зависит от направления и формата (группа или индивидуально). Точную цену подскажем после пробного занятия — позвоните или напишите, расскажем подробно.",
  },
  {
    question: "Во сколько проходят занятия?",
    answer: "Мы работаем с понедельника по пятницу, с 09:30 до 18:30. Расписание занятий формируется индивидуально — подберём удобное время для вашего ребёнка.",
  },
  {
  ...
  },
  {
    ...
    answer: "Да, можно записаться на любое количество направлений. Часто дети совмещают, например, подготовку к школе и английский, или помощь школьникам и театр.",
  },
  {
